           ...
           <Navbar/>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-4" style={{height: "570px", borderRight : "1px solid white", marginBottom:"0px"}}>
                         <div class="row my-5 ms-4">
                             <div class="col-2 mt-2">
                             <img class="rounded-circle" src="images/caca1.jpg" width={"50px"}/>
                             </div>
                             <div class="col mt-1">
                                <p style={{fontSize: "14px", color: "white", fontWeight: "bold"}}>Admin</p>
                                <p style={{fontSize: "12px", color: "white"}}>Hallo Admin, I need your help!</p>
                             </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        ...
                        <div class="row">
                         ...
                         <div class="col-6">
                            ...
                            <div class="talktext">
                                <p>Hallo Admin, I need your help!</p>
                            </div>
                            </div>
                            </div>
