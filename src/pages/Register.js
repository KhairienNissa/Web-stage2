              ...
              <div class="row mt-5">
                ...
                <div class="col-md-5">
                    <div class="row row-cols-1 row-cols-md-2 justify-content-center mt-4">
                         <div class="col mb-4 ">
                             <div class="card bor" style={{background: "#181818", width: "416px", height: "443px"}}>
                                <div class="card-body" style={{background: "#181818", width: "350px", margin: "20px auto"}}>
                                  <h2 style={{background: "#181818"}} class="text-white mb-5">Register</h2>
                                 <form>
                                     <div style={{background: "#181818"}} class="form-group">
                                         ...
                                         <div class="row">
                                             <button type="button" class="btn btn-lg btn-block fs-6 text-white" style={{background: "#F74D4D"}}>Register</button>
                                         </div>
                                     </div>
                                </form>
                              </div>
